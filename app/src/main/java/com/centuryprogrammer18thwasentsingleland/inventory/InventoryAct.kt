...
import com.centuryprogrammer18thwasentsingleland.databinding.ActInventoryBinding
...
class InventoryAct : AppCompatActivity() {
    private val TAG = InventoryAct::class.java.simpleName

    private lateinit var binding: ActInventoryBinding

    private lateinit var masterKeyAlias: String
    private lateinit var sharedPrefs: SharedPreferences

    val viewModel :InventoryActVM by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setActionBarTitle(getString(R.string.inventory))

        binding = DataBindingUtil.setContentView(this,R.layout.act_inventory)
        ...
        makeActionBarTitle(getString(R.string.inventory))
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    fun makeActionBarTitle(whichPage: String){
        val title = StringBuilder().append(getString(R.string.app_name)).append(" - ").append(whichPage).toString()
        Log.d(TAG,"***** title is ${title} *****")
        supportActionBar?.setTitle(title)
    }
}