...
import com.centuryprogrammer18thwasentsingleland.databinding.ActivityReleaseBinding
...
class ReleaseAct : AppCompatActivity() {
    private val TAG = ReleaseAct::class.java.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setActionBarTitle(getString(R.string.releases))
...
//        ref https://www.journaldev.com/9357/android-actionbar-example-tutorial
    ...
    fun addTeam(){
        val navCont = findNavController(R.id.frgReleaseAct)
