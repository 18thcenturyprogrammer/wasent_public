...
import com.centuryprogrammer18thwasentsingleland.databinding.DetailBaseItemRemoveDialogFrgBinding
...
class DetailBaseItemRemoveDialogFrg : DialogFragment() {
    private val TAG = DetailBaseItemRemoveDialogFrg::class.java.simpleName

    private lateinit var args : DetailBaseItemRemoveDialogFrgArgs
    private lateinit var binding : DetailBaseItemRemoveDialogFrgBinding

    lateinit var masterKeyAlias : String
    lateinit var sharedPrefs : SharedPreferences

    private val viewModel : DetailBaseItemRemoveDialogFrgVM by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        // getting args from previous fragment
        args = DetailBaseItemRemoveDialogFrgArgs.fromBundle(requireArguments())
...
//        eventually, i decided i will send user out of program when they change sharedPrefs
        ...
        viewModel.detailBaseItemPushKey = args.detailBaseItemPushKey
    }
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        binding = DataBindingUtil.inflate(layoutInflater, R.layout.detail_base_item_remove_dialog_frg,null, false)
        binding.viewModel = viewModel

        val builder = AlertDialog.Builder(requireContext())

        builder.setTitle(R.string.remove_item)
        val message : String = args.detailBaseItemPushKey.replace("_"," ")+" : "+getString(R.string.do_you_want_remove_item)
...
//                viewModel.changeCloseDialogTo(true)
                ...
                val action = DetailBaseItemRemoveDialogFrgDirections.actionDetailBaseItemRemoveDialogFrgToDetailBaseItemFrg()
