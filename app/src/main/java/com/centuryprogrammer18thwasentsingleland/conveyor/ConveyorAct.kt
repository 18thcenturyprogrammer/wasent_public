...
import com.centuryprogrammer18thwasentsingleland.databinding.ActConveyorBinding
...
class ConveyorAct: AppCompatActivity() {
    private val TAG = ConveyorAct::class.java.simpleName

    private lateinit var binding: ActConveyorBinding

    private lateinit var masterKeyAlias: String
    private lateinit var sharedPrefs: SharedPreferences

    val viewModel : ConveyorActVM by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setActionBarTitle(getString(R.string.conveyor))

        binding = DataBindingUtil.setContentView(this, R.layout.act_conveyor)
